        ...
        <div className="max-w-4xl mx-auto glass-effect rounded-lg p-8 sm:p-10 lg:p-12 shadow-xl">
          ...
          <div className="prose max-w-none space-y-6 text-lg text-gray-700 leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named NamApp.</li>
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NamApp.</li>
              <li><strong>Country</strong> refers to Namibia.</li>
            ...
            <h3 className="text-xl font-semibold mt-8 mb-4">Links to Other Websites</h3>
